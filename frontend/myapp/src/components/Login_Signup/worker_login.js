...
export default function WorkerLogin()
{
    ...
    async function verify(){
        await axios.post('/employee/auth', 
          form  
          )
            ...
            <div className="container mx-auto">
                <div className="flex flex-col items-center justify-center mt-16 w-1/3 mx-auto p-4 gap-8 rounded-xl bg-[#303030]">
                    ...
                    <div className='flex flex-row items-center justify-center w-4/5 border-b-[0.5px] border-b-white'>
                        <h1 className='text-white font-[Poppins] text-xl font-semibold py-4'>Employee Login</h1>
                    </div>
                    ...
                    <h1 onClick={()=>{navigate('/WorkerSignup')}} className='text-white font-[Poppins] text-base font-semibold hover:underline underline-offset-8 underline-white duration-200 hover:cursor-pointer'>Not registered? Signup Now!</h1>
                    </div>
