...
export default function MayorGarbage() {
        ...
        <div className="w-full h-max bg-[#171717]  py-2 mt-14">
                <div className="container mx-auto h-[565px] my-16 text-white w-6/12 rounded-xl border-2 border-white">
                    <div className="flex flex-col items-center justify-center gap-4">
                        <h1 className="font-[Poppins] text-xl text-white py-4 border-b-2 border-b-orange-200 w-full">Garbage and Sewage department</h1>
